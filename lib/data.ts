...
export const projects: Project[] = [
  {
    ...
    cover: {
      ...
      svg: `<svg viewBox="0 0 320 180" fill="none" xmlns="http://www.w3.org/2000/svg" class="cover-svg">
        ...
        <path d="M88 90 H136" stroke="rgba(255,255,255,0.6)" stroke-width="1.5"/>
    ...
    problem:
      "Government services are usually a maze of forms, disjointed PDFs, and disconnected regional departments. Citizens give up halfway, resulting in backlogs, manual in-person visits, and profound civic frustration. Kriya explored a single orchestrated layer that turns multi-step bureaucratic processes into a calm, guided experience.",
    idea:
      "A single conversational + form-based surface that orchestrates multiple back-office services. The user expresses intent in natural language; the system automatically resolves cross-department prerequisites, handles routing, validates attachments on the fly, and tracks status.",
    process: [
    ...
    learned:
      "The hardest part of designing for government is not the UI. It's the seams between departments. The interface must make those seams invisible without hiding the truth or accountability from the citizen.",
    nextSlug: "unidash",
  },
  {
    slug: "unidash",
    ...
    problem:
      "Most dashboards show walls of numbers, colorful sparklines, and disconnected bar charts. Few explain them. Operators spend hours deciphering what anomalous spikes mean and debating causation before taking action. UniDash was an exploration of how a data product could narrate its own state — surfacing what changed, why it changed, and what to do about it.",
    idea:
      "A modular, narrative-first data workspace where every visualization is paired with a concise natural-language explainer: the change delta, the probable root cause, and a recommended tactical next step.",
    process: [
    ...
    learned:
      "Data products should optimize for time-to-decision, not time-to-insight. An insightful chart without operational direction is merely a decoration, not a tool.",
  ...
  },
  {
    ...
    problem:
      "Healthcare shift workers and bedside nurses are surveyed constantly by HR, but rarely see visible changes. Exhausted after a 12-hour trauma rotation, nobody wants to fill out a 20-question survey. RateMyShift explored a lightweight, in-the-moment feedback loop that respects precious time, emotional bandwidth, and psychological safety.",
    idea:
      "A 10-second end-of-shift micro-survey with tactile tap-based sentiments, adaptive branching questions, and an open, public accountability loop that shows which hospital policies were updated as a direct result.",
    process: [
    ...
    learned:
      "Feedback tools fail when the feedback loop is a black hole. Frontline workers will share candidly when they can visibly witness that speaking up directly improves their tomorrow.",
  ...
  },
  {
    ...
    problem:
      "Patients navigating chronic illnesses repeatedly answer identical questions on clipboards in sterile waiting rooms. Intake forms are long, cold, disconnected from past medical encounters, and rarely synthesized into actionable briefs for the attending physician.",
    idea:
      "A persistent patient health narrative that pre-fills previous records, updates incrementally, and travels seamlessly across care specialists — accompanied by an AI clinician brief that summarizes recent delta changes in under 30 seconds.",
    process: [
    ...
    learned:
      "Healthcare UX is fundamentally not a button or layout problem. It is an information trust problem. The interface is simply the visible boundary of a complex negotiation between vulnerable humans and rigid institutions.",
...
export const articles: Article[] = [
  ...
  },
  {
    ...
    tag: "Writing & Content",
    excerpt:
      "Words are not decorative garnish sprinkled on top of wireframes. They are the structural beams of the user's mental model.",
    body: [
  ...
  },
  {
    ...
    tag: "Data UX",
    excerpt:
      "Dashboards shouldn't optimize for vanity metrics and endless exploration. They should optimize for rapid, confident human decisions.",
    body: [
